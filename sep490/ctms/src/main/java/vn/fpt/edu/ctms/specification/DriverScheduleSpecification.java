...
//            }
            ...
            if (!StringUtils.isEmpty(driverSchedule.getLicensePlate())) {
                predicateList.add((criteriaBuilder.equal(root.get("containerTruck").get("licensePlate"),"%" + driverSchedule.getTruckId() + "%" )));
            }
            ...
            if (!StringUtils.isEmpty(driverSchedule.getDriverNumber())) {
                predicateList.add((criteriaBuilder.equal(root.get("driver").get("userNumber"),"%" + driverSchedule.getDriverNumber() + "%")));
            }
            ...
            if (!StringUtils.isEmpty(driverSchedule.getTimeStamp())) {
                predicateList.add((criteriaBuilder.equal(root.get("time_stamp"),"%" + driverSchedule.getTimeStamp() + "%")));
            }
